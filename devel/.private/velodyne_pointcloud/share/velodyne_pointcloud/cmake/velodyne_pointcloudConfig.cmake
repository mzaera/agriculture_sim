...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_pointcloud_SOURCE_PREFIX /home/developer/agriculture_sim/src/velodyne/velodyne_pointcloud)
  set(velodyne_pointcloud_DEVEL_PREFIX /home/developer/agriculture_sim/devel/.private/velodyne_pointcloud)
  ...
  set(velodyne_pointcloud_INSTALL_PREFIX /home/developer/agriculture_sim/install)
...
if(NOT "/home/developer/agriculture_sim/devel/.private/velodyne_pointcloud/include;/home/developer/agriculture_sim/src/velodyne/velodyne_pointcloud/include " STREQUAL " ")
  set(velodyne_pointcloud_INCLUDE_DIRS "")
  set(_include_dirs "/home/developer/agriculture_sim/devel/.private/velodyne_pointcloud/include;/home/developer/agriculture_sim/src/velodyne/velodyne_pointcloud/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/developer/agriculture_sim/src/velodyne/velodyne_pointcloud/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/developer/agriculture_sim/devel/.private/velodyne_pointcloud/lib;/home/developer/agriculture_sim/devel/lib;/home/developer/catkin_ws/devel/lib;/opt/ros/melodic/lib)
