...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_pcl_SOURCE_PREFIX /home/developer/agriculture_sim/src/velodyne/velodyne_pcl)
  set(velodyne_pcl_DEVEL_PREFIX /home/developer/agriculture_sim/devel/.private/velodyne_pcl)
  ...
  set(velodyne_pcl_INSTALL_PREFIX /home/developer/agriculture_sim/install)
...
if(NOT "/home/developer/agriculture_sim/src/velodyne/velodyne_pcl/include " STREQUAL " ")
  set(velodyne_pcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/developer/agriculture_sim/src/velodyne/velodyne_pcl/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_pcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/developer/agriculture_sim/src/velodyne/velodyne_pcl/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/developer/agriculture_sim/devel/.private/velodyne_pcl/lib;/home/developer/agriculture_sim/devel/lib;/home/developer/catkin_ws/devel/lib;/opt/ros/melodic/lib)
