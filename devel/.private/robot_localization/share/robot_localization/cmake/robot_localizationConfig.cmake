...
if("TRUE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /home/developer/agriculture_sim/src/robot_localization)
  set(robot_localization_DEVEL_PREFIX /home/developer/agriculture_sim/devel/.private/robot_localization)
  ...
  set(robot_localization_INSTALL_PREFIX /home/developer/agriculture_sim/install)
...
if(NOT "/home/developer/agriculture_sim/devel/.private/robot_localization/include;/home/developer/agriculture_sim/src/robot_localization/include;/usr/include/eigen3 " STREQUAL " ")
  set(robot_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/developer/agriculture_sim/devel/.private/robot_localization/include;/home/developer/agriculture_sim/src/robot_localization/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/developer/agriculture_sim/src/robot_localization/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/developer/agriculture_sim/devel/.private/robot_localization/lib;/home/developer/agriculture_sim/devel/lib;/home/developer/catkin_ws/devel/lib;/opt/ros/melodic/lib)
